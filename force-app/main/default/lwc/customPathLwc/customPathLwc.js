...
import PICKLIST_FIELD from '@salesforce/schema/Application__c.Agent_Status__c';
...
const FIELDS = [
    'Application__c.Id',
    'Application__c.Agent_Status__c'
];
...
export default class CustomPathLwc extends LightningElement {
    ...
    get picklistValues() {
        ...
        if (this.record.data) {
            if (!this.selectedValue && this.record.data.fields.Agent_Status__c.value) {
                this.selectedValue = this.record.data.fields.Agent_Status__c.value + '';
            }
    ...
    handleMarkAsSelected() {
        ...
        fields.Agent_Status__c = this.selectedValue;
