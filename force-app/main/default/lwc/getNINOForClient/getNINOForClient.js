        ...
        getApplicationData({
            ...
            data => {
                if (data.isSuccess) {
                    ...
                    this.getNINOData = data?.application?.First_Name__c +
                                       ' - We\'d love feedback on your UK State Pension Top Up experience with XtraPension.\n\n' +
                                       'Click https://xtrapension.com/review';
